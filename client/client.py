	...
	def keyPressEvent(self, event):
		...
		if not event.isAutoRepeat():
			if key_press == Qt.Key_Up:      # up
				...
				run_action('fwleft')
			elif key_press == Qt.Key_Z:     # W
				run_action('camup')
			elif key_press == Qt.Key_S:     # A
				run_action('camdown')
			elif key_press == Qt.Key_Q:     # S
				run_action('camleft')
			elif key_press == Qt.Key_D:     # D
				run_action('camright')
			elif key_press == Qt.Key_Y:
				run_action('nodyes')
			elif key_press == Qt.Key_N:
				run_action('nodno')
	...
	def keyReleaseEvent(self, event):
		...
		if not event.isAutoRepeat():
			if key_release == Qt.Key_Up:    # up
				...
				run_action('fwstraight')
			elif key_release == Qt.Key_Q:   # W
				run_action('camready')
			elif key_release == Qt.Key_Z:   # A
				run_action('camready')
			elif key_release == Qt.Key_D:   # S
				run_action('camready')
			elif key_release == Qt.Key_S:   # D
				run_action('camready')
